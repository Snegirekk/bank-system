insert into public.addresses (id, country, locality, address1, post_code) values
...
insert into public.customers (id, first_name, last_name, address_id, birthday) values
...
insert into public.transaction_participants (id, type) values
    ('bf2ac5d3-d36f-4b17-b767-d5884a647794', 'ACCOUNT'),
    ('4fe21a4e-ac79-40b9-955c-05ae8cd349ac', 'ACCOUNT');

insert into public.accounts (id, amount, customer_id, transaction_participant_id) values
